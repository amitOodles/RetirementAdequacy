app.service('PdfMaker', [function() {
    ...
    this.createChart = function(personalDetails,personalDetailsSpouse, assumptions,assumptionsSpouse,otherAssets){
        ...
        var rowsP3 = [
            ...
            { "info": "2) The calculator also aims to identify any gap between your projected superannuation savings at retirement and your expected retirement income"},
            { "info": "2) The calculator also aims to show you how different factors such as your current age, your planned retirement age, current annual income and investments could impact your retirement savings and encourage you to actively manage your superannuation."}
        ];

        var columns1 = [
            { title: "General Information (Member 1)", dataKey: "info1"},
        ...
        var rows1 = [
            ...
            { "info1": "Do you have a spouse?", "value": personalDetails.spouseOption },
            { "info1": "Do you own a house?", "value": personalDetails.houseOption },
        ...
        var columns2 = [
            { title: "Assumptions (Member 1)", dataKey: "assume1" },
        ...
        var rows2 = [
            ...
            { "assume1": "Pension Drawdown", "value": moneyFormat.to(assumptions.pensionDrawdown)},
        ...
        var rows6 = [
            ...
            { "assume2": "Pension Drawdown", "value": moneyFormat.to(assumptionsSpouse.pensionDrawdown)},
